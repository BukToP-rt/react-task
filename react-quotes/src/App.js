...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path='/technology' element={<CategoryPage category="technology" ></CategoryPage>}/>
      <Route path='/famous' element={<CategoryPage category="Famous Quotes" ></CategoryPage>}/>
    ...
    <div className="App">
      ...
      <div className="section">
        ...
        <div className="container-main">
          ...
          <div className="posts">
            <div className="post">
              <a href="/">Текст будующей цитаты</a>
              <div className="author">
                <a href="/">Автор цитаты</a>
              </div>
